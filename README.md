...
### [Repository on Github](https://github.com/vpham26/ORM-ECommerce-BackEnd)
...
![In Insomnia Core, the user tests “GET tags,” “GET tag by ID" ,and “PUT update Tag" , "DELETE Tag by ID" , "POST create New Tag”.](./assets/images/tags.gif)
...
![In Insomnia Core, the user tests "GET Categories", “GET Categories by ID”, “PUT update Category", "DELETE category by ID", "POST create category".](./assets/images/categories.gif)
...
![In Insomnia Core, the user tests “GET product", "GET products", “CREATE product,” and “UPDATE product.”](./assets/images/product.gif)
...
## Questions
 ...
 Email: <a href="mailto:vulong.pham26@gmail.com">vulong.pham26@gmail.com</a>

 Github: <a href="https://github.com/vpham26">vpham26</a>
